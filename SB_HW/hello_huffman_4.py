...
# def dict_to_list(key_value_dict):
#         key_value_list = []
#         for key, value in key_value_dict.items():
#                 temp = [key,value]
#                 key_value_list.append(temp)
#         sorted_key_value_list = sorted(key_value_list, key=lambda x: x[1])
#         return sorted_key_value_list

# discrete_value_list_X = dict_to_list(discrete_value_dict_X)
# discrete_value_list_Y = dict_to_list(discrete_value_dict_Y)
# discrete_value_list_Z = dict_to_list(discrete_value_dict_Z)

# print(discrete_value_list_X)

# class HuffNode(object):
#         def get_weight(self):
#                 raise NotImplementedError("The Abstract Node Class doesn't define 'get_weight'")
#         def is_leaf(self):
#                 raise NotImplementedError("The Abstract Node Class doesn't define 'is_leaf'")
